...
# import traceback  # <-- NEW: Import traceback for detailed errors
#
...
#             break
#
#     # ... (Step 7 - Call Hotel Service - NO CHANGES) ...
#     if hotel_service_data["daily_locations"]:
#         hotel_service_endpoint = f"{settings.HOTEL_SERVICE_URL}/find-hotels"
...
#     new_trip = None
#     try:
#         print("--- Attempting to save trip to database... ---")
#         trip_data_to_insert = {
#             "num_people": request.num_people,
...
#
#         print("--- Insert command executed. Checking response... ---")
#         sys.stdout.flush()
#
#         if not trip_insert_response.data:
#             print("--- ERROR: Insert response returned no data. ---", file=sys.stderr)
#             sys.stderr.flush()
...
#         print("---!!! ENCOUNTERED ERROR SAVING TRIP !!!---", file=sys.stderr)
#         print(f"Supabase error saving trip: {e}", file=sys.stderr)
#         traceback.print_exc(file=sys.stderr)  # Print the full stack trace
#         sys.stderr.flush()  # Force the error log to print
#         # --- END FIX ---
